...
public class Memo1BankApp {
	...
	@ResponseStatus(HttpStatus.CREATED)
	public Transaction newWithdraw(@RequestBody Transaction transaction) {
	...
	public Transaction newDeposit(@RequestBody Transaction transaction) {
		return accountService.newDeposit(transaction);
	}
	...
	public Collection<Transaction> getTransactionsFromClient(@PathVariable Long cbu) {
		return accountService.getService().getClientTransactions(cbu);
	}

	@GetMapping("/transactions")
	public Collection<Transaction> getTransactions() {
		return accountService.getService().showTransactions();
	}
